...
This repository serves as my technical log and project portfolio. Here, I document my evolution from web fundamentals to building scalable applications using the **MERN Stack**, combining intensive coding practice with industry-standard certifications.

---

## 🗺️ Learning Roadmap

### 🟢 Phase 1: The Foundations (HTML, CSS & Logic)
...
- [ ] Full MERN Stack Integration (Frontend + Backend + DB)
- [ ] Course: Server-Side Development with Node.js and Express (IBM) 🎓
